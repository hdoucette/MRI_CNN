...
train_path=os.path.join(root,'3D-Convnet-for-Alzheimer-s-Detection/3D_CNN/Data/train_data.csv')
with open(train_path, 'w',newline= '') as writeFile:
     writer = csv.writer(writeFile)
     writer.writerows(path for path in train)

test_path=os.path.join(root,'3D-Convnet-for-Alzheimer-s-Detection/3D_CNN/Data/test_data.csv')
